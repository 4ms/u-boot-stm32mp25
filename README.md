This is forked from STM's U-boot, tag v2022.10-stm32mp-beta-r1.
Then it's been patched with the mp25 patches (see git log).
Finally, a defconfig and bootcmd for baremetal booting was created, and 
then various fixes to make it possible to compile on macOS were made.
